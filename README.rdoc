...
Questions:
1. Should I wrap the models, serializers, and tests in the V1 module?
2. How should the routes be configured?
3. Although it's a bit late for TDD, how should the tests be written?
